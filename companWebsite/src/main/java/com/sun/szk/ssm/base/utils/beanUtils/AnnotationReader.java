...
import com.sun.szk.ssm.base.annotationResolver.BaseResolver;
import com.sun.szk.ssm.base.exception.UtilException;
import com.sun.szk.ssm.base.utils.SpringContextUtils;
				...
				for (Annotation annotation : field.getDeclaredAnnotations()) {
					...
					if (pd.getReadMethod().isAnnotationPresent(Id.class)
						...
						entityBinder.getIdBinderList()
								.add(new IdBinder(pd.getName(), pd,
					...
					entityBinder.getAnnotationBinders()
							.get(entityBinder.getAnnotationBinders()
									.indexOf(new AnnotationBinder((Class<Annotation>) annotation.annotationType())))
							.getFields().add(field);
				}
			}
		} catch (Exception e) {
