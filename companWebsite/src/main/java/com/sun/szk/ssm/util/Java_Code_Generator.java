...
public class Java_Code_Generator {
	...
	private static String url = res.getString("jdbc_url").replace("${jdbc_database}", dbInstance);
	 ...
	 *            生成那些模板
	 */
	public static void create(String tableName, String codeName, String modulePakPath, String modulePackage,
