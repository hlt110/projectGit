...
<script>
    function doLogin(){
        ...
        if (managerName == null || $.trim(managerName) == "") {
            alert("用户名不能为空");
            $("#managerName").focus();
            return false;
            ...
            $.ajax({
                ...
                success : function(data) {
                    eval('data = ' + data);
                    if (data.code == 1) {
                        window.location.href = "management/main";
                    } else {
                        alert(data.message);
                        $("#password").focus();
                    }
            ...
            <div class="col-sm-8 col-md-5 center-auto pd-sm-50 pd-xs-20 main_content">
                ...
                <form>
                    <div class="form-group mg-t20">
                        ...
                        <input type="email" id="managerName" class="login_input"  placeholder="请输入用户名" />
                    </div>
                    <div class="form-group mg-t20">
                    ...
                    <button style="submit" class="login_btn" onclick="return doLogin();">登 录</button>
               </form>
        </div><!--row end-->
    </div><!--container end-->
